from database import DatabaseError, InMemoryDatabase
...
class ConsoleInterface:
    ...
    def handle_list_tables(self):
        ...
        for table_name in table_names:
            ...
            print(f"{table.name}: fields [{fields}], records: {len(table.records)}")
    ...
    def ask_sorting(self, fields):
        available_fields = ["id"] + fields
        print("Available sort fields:", ", ".join(available_fields))
...
def create_application():
    return ConsoleInterface(InMemoryDatabase())
